...
const BenefitsSection: React.FC = () => {
  return (
    <section id="beneficios" className="bg-black text-white py-20 border-t border-border/60">
      <div className="container mx-auto">
        <h2 className="text-2xl md:text-3xl font-bold tracking-tight">Benefícios que elevam sua performance</h2>
        <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {items.map(({ icon: Icon, title, desc }) => (
            <div key={title} className="group rounded-xl border border-border/60 bg-gradient-to-b from-white/[0.02] to-transparent p-6">
